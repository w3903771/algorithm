...
| [牛客提交报告](solutions/_submit_report.md) | 各题在**牛客判题机**上的真实判定结果 |
...
题解：**165 / 165 已写，165 题通过官方样例，165 题通过牛客判题机实测**

> 其中 5 题（BISHI103 / 128 / 130 / 138 / 147）登记为 **PyPy3** 提交：
> 算法已是最优形态，纯粹是 CPython 的常数过不去。
> 语言覆盖表见 [`solutions/_lang.json`](solutions/_lang.json)，理由写在各题解的文档字符串里。
