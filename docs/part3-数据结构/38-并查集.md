...
题解：[`solutions/BISHI102.py`](../solutions/BISHI102.md)（已通过牛客判题机验证）
### BISHI104 修复公路（中等）
...
题解：[`solutions/BISHI104.py`](../solutions/BISHI104.md)（已通过牛客判题机验证）
...
题解：[`solutions/BISHI98.py`](../solutions/BISHI98.md)（已通过牛客判题机验证）
