...
| 知识点 | 课件位置 | 解决什么问题 |
| --- | --- | --- |
| **CRT**（Chinese remainder theorem，中国剩余定理） | day9《数论（李有为）》第 28–29、38–41 页 | 已知 $x \bmod p_i$，还原 $x$ |
| **BSGS**（baby-step giant-step，大步小步算法） | 同上第 51–52 页；day10 第 29 页 | 已知 $a^x \equiv b$，求 $x$（**离散对数**） |
