...
| 题号 | 标题 | 考点 | 题解 |
| --- | --- | --- | --- |
| PIO1 | 只有输出 | 无输入 | [`solutions/PIO1.py`](../solutions/PIO1.md) |
| PIO2 | 单组_A+B | `input().split()` | [`solutions/PIO2.py`](../solutions/PIO2.md) |
| PIO3 | 多组_A+B_EOF形式 | 迭代 `sys.stdin` | [`solutions/PIO3.py`](../solutions/PIO3.md) |
| PIO4 | 多组_A+B_T组形式 | token 流 + 游标 | [`solutions/PIO4.py`](../solutions/PIO4.md) |
| PIO5 | 多组_A+B_零尾模式 | 哨兵判断 | [`solutions/PIO5.py`](../solutions/PIO5.md) |
| PIO6 | 单组_一维数组 | `sum(map(int, ...))` | [`solutions/PIO6.py`](../solutions/PIO6.md) |
| PIO7 | 多组_一维数组_T组形式 | 游标跳 $n$ | [`solutions/PIO7.py`](../solutions/PIO7.md) |
| PIO8 | 单组_二维数组 | 换行无关性 | [`solutions/PIO8.py`](../solutions/PIO8.md) |
| PIO9 | 多组_二维数组_T组形式 | 游标跳 $n \times m$ | [`solutions/PIO9.py`](../solutions/PIO9.md) |
| PIO10 | 单组_字符串 | `s[::-1]`、`strip()` | [`solutions/PIO10.py`](../solutions/PIO10.md) |
| PIO11 | 多组_字符串_T组形式 | `bytes.decode()` | [`solutions/PIO11.py`](../solutions/PIO11.md) |
| PIO12 | 单组_二维字符数组 | 双重反转 | [`solutions/PIO12.py`](../solutions/PIO12.md) |
| PIO13 | 多组_带空格的字符串 | `readline()` | [`solutions/PIO13.py`](../solutions/PIO13.md) |
| PIO14 | 单组_保留小数位数 | `Decimal` + `ROUND_HALF_UP` | [`solutions/PIO14.py`](../solutions/PIO14.md) |
| PIO15 | 单组_补充前导零 | `zfill` | [`solutions/PIO15.py`](../solutions/PIO15.md) |
| PIO16 | 单组_spj判断YES与NO | spj、`n & 1` | [`solutions/PIO16.py`](../solutions/PIO16.md) |
| PIO17 | 单组_spj判断浮点误差 | `math.pi`、位数冗余 | [`solutions/PIO17.py`](../solutions/PIO17.md) |
| PIO18 | 单组_spj判断数组之和 | 构造类 spj | [`solutions/PIO18.py`](../solutions/PIO18.md) |
