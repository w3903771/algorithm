...
更彻底的办法是把递归改写成显式栈的迭代版本，见 [60-DFS深度优先搜索](../part5-搜索/60-DFS深度优先搜索.md#604-递归改迭代)。
...
| 题号 | 标题 | 考点 | 题解 |
| --- | --- | --- | --- |
| PIO1 | 只有输出 | 无输入 | [`solutions/PIO1.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO1.py) |
| PIO2 | 单组_A+B | `input().split()` | [`solutions/PIO2.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO2.py) |
| PIO3 | 多组_A+B_EOF形式 | 迭代 `sys.stdin` | [`solutions/PIO3.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO3.py) |
| PIO4 | 多组_A+B_T组形式 | token 流 + 游标 | [`solutions/PIO4.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO4.py) |
| PIO5 | 多组_A+B_零尾模式 | 哨兵判断 | [`solutions/PIO5.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO5.py) |
| PIO6 | 单组_一维数组 | `sum(map(int, ...))` | [`solutions/PIO6.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO6.py) |
| PIO7 | 多组_一维数组_T组形式 | 游标跳 $n$ | [`solutions/PIO7.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO7.py) |
| PIO8 | 单组_二维数组 | 换行无关性 | [`solutions/PIO8.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO8.py) |
| PIO9 | 多组_二维数组_T组形式 | 游标跳 $n \times m$ | [`solutions/PIO9.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO9.py) |
| PIO10 | 单组_字符串 | `s[::-1]`、`strip()` | [`solutions/PIO10.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO10.py) |
| PIO11 | 多组_字符串_T组形式 | `bytes.decode()` | [`solutions/PIO11.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO11.py) |
| PIO12 | 单组_二维字符数组 | 双重反转 | [`solutions/PIO12.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO12.py) |
| PIO13 | 多组_带空格的字符串 | `readline()` | [`solutions/PIO13.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO13.py) |
| PIO14 | 单组_保留小数位数 | `Decimal` + `ROUND_HALF_UP` | [`solutions/PIO14.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO14.py) |
| PIO15 | 单组_补充前导零 | `zfill` | [`solutions/PIO15.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO15.py) |
| PIO16 | 单组_spj判断YES与NO | spj、`n & 1` | [`solutions/PIO16.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO16.py) |
| PIO17 | 单组_spj判断浮点误差 | `math.pi`、位数冗余 | [`solutions/PIO17.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO17.py) |
| PIO18 | 单组_spj判断数组之和 | 构造类 spj | [`solutions/PIO18.py`](https://github.com/w3903771/algorithm/blob/main/solutions/PIO18.py) |
