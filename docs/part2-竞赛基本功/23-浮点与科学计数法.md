...
`Decimal(字符串)` + `ROUND_HALF_UP`。题解：[`solutions/PIO14.py`](../../solutions/PIO14.py)
...
远超 $10^{-3}$）；**输出位数宁多勿少**。题解：[`solutions/PIO17.py`](../../solutions/PIO17.py)
...
> 完整实现见 [`solutions/BISHI14.py`](../../solutions/BISHI14.py)，
