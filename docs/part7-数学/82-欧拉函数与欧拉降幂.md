...
> 题面见 [`sources/05-nowcoder/problems/BISHI73.md`](../../sources/05-nowcoder/problems/BISHI73.md)。
...
题解见 [`solutions/BISHI73.py`](../../solutions/BISHI73.py)。

### BISHI75 阶幂（中等）

> 定义 $fp(n) = 1$（$n \le 1$）、$fp(n) = n^{fp(n-1)}$（$n \ge 2$）。
> 给定 $1 \le n \le 10^6$，求 $fp(n) \bmod (10^9+7)$。
> 题面见 [`sources/05-nowcoder/problems/BISHI75.md`](../../sources/05-nowcoder/problems/BISHI75.md)。
...
题解见 [`solutions/BISHI75.py`](../../solutions/BISHI75.py)。
