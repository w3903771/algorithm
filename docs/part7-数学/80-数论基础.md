...
> 题面见 [`sources/05-nowcoder/problems/BISHI55.md`](../../sources/05-nowcoder/problems/BISHI55.md)。
...
题解见 [`solutions/BISHI55.py`](../../solutions/BISHI55.py)。

### BISHI56 分解质因数（简单）

> 给定 $2 \le n \le 10^{12}$，按从小到大顺序输出 $n$ 的全部质因数（重数展开），
> 空格分隔、**行尾不得有多余空格**。
> 题面见 [`sources/05-nowcoder/problems/BISHI56.md`](../../sources/05-nowcoder/problems/BISHI56.md)。
...
题解见 [`solutions/BISHI56.py`](../../solutions/BISHI56.py)。

### BISHI57 最大公因数与最小公倍数（简单）

> 给定 $1 \le a, b \le 2\times10^9$，输出 $\gcd(a,b)$ 与 $\operatorname{lcm}(a,b)$，空格分隔。
> 题面见 [`sources/05-nowcoder/problems/BISHI57.md`](../../sources/05-nowcoder/problems/BISHI57.md)。
...
题解见 [`solutions/BISHI57.py`](../../solutions/BISHI57.py)。
...
> 题面见 [`sources/05-nowcoder/problems/BISHI58.md`](../../sources/05-nowcoder/problems/BISHI58.md)。
...
题解见 [`solutions/BISHI58.py`](../../solutions/BISHI58.py)。
