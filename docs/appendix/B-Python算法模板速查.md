...
> 本附录按 S4 `模板.docx`（NOIP 复赛算法模板清单）的组织方式，把全书模板汇总成一处。
...
> **写用 `"\n".join()`**。详见 [20-输入输出处理](../part2-竞赛基本功/20-输入输出处理.md)。
>
> 递归深度：
> ```python
> import threading
...
详见 [22-高精度与大整数](../part2-竞赛基本功/22-高精度与大整数.md)。
...
详见 [40-排序](../part4-基础算法/40-排序.md)、[12-自定义排序](../part1-python基础/12-自定义排序.md)。
...
详见 [42-前缀和与差分](../part4-基础算法/42-前缀和与差分.md)。
...
详见 [32-栈](../part3-数据结构/32-栈.md)、[33-队列与双端队列](../part3-数据结构/33-队列与双端队列.md)。
...
> 详见 [37-单调栈与单调队列](../part3-数据结构/37-单调栈与单调队列.md)。

---

## B.6　并查集

详见 [38-并查集](../part3-数据结构/38-并查集.md)。
...
详见 [35-优先队列与堆](../part3-数据结构/35-优先队列与堆.md)。
...
详见 [39-树状数组与线段树](../part3-数据结构/39-树状数组与线段树.md)。
...
完整实现（`LazySeg`）见 [39 章](../part3-数据结构/39-树状数组与线段树.md)。
...
详见 [34-集合与多重集合](../part3-数据结构/34-集合与多重集合.md)、
...
详见 [70-字符串处理](../part6-字符串/70-字符串处理.md) ~ [73-Trie字典树](../part6-字符串/73-Trie字典树.md)。
...
> 或用双模哈希。详见 [36 章](../part3-数据结构/36-哈希与字符串哈希.md)。
...
详见 [60-DFS](../part5-搜索/60-DFS深度优先搜索.md) ~ [62-记忆化](../part5-搜索/62-记忆化搜索与剪枝.md)。
...
详见 [90-图的表示与遍历](../part8-图与树/90-图的表示与遍历.md) ~ [94-树上算法](../part8-图与树/94-树上算法.md)。
...
> 替代路线是「欧拉序 + 分块 + 块间 ST 表」，见 [94 章](../part8-图与树/94-树上算法.md)。

---

## B.13　数论

详见 [80-数论基础](../part7-数学/80-数论基础.md) ~ [84-组合数学](../part7-数学/84-组合数学.md)。
...
详见 [100-DP入门](../part9-动态规划/100-DP入门.md) ~ [104-DP优化](../part9-动态规划/104-DP优化.md)。
...
详见 [46-位运算](../part4-基础算法/46-位运算.md)。
...
> 完整的避坑清单见 [附录 C](C-Python竞赛避坑清单.md)。
