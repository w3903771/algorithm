...
> 孤立点输出 `None`。
> 题面见 [BISHI95 原题（牛客）](https://www.nowcoder.com/practice/23f622c8b15f4b37bffe1a986eeea185)。
> 题解见 [`solutions/BISHI95.py`](https://github.com/w3903771/algorithm/blob/main/solutions/BISHI95.py)（已用官方样例验证）。
...
> 题解见 [`solutions/BISHI99.py`](https://github.com/w3903771/algorithm/blob/main/solutions/BISHI99.py)（已用官方样例验证）。
