...
> 题解见 [`solutions/BISHI106.py`](../solutions/BISHI106.md)（已用官方样例验证）。
...
> 题解见 [`solutions/BISHI108.py`](../solutions/BISHI108.md)（已用官方样例验证）。
...
> 题解见 [`solutions/BISHI109.py`](../solutions/BISHI109.md)（已用官方样例验证）。
