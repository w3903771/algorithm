...
> 时限：C/C++ 5 秒，其他语言 10 秒。
> 题面见 [`sources/05-nowcoder/problems/BISHI106.md`](../../sources/05-nowcoder/problems/BISHI106.md)。
> 题解见 [`solutions/BISHI106.py`](../../solutions/BISHI106.py)（已用官方样例验证）。
...
> 题面见 [`sources/05-nowcoder/problems/BISHI108.md`](../../sources/05-nowcoder/problems/BISHI108.md)。
> 题解见 [`solutions/BISHI108.py`](../../solutions/BISHI108.py)（已用官方样例验证）。
...
> 题面见 [`sources/05-nowcoder/problems/BISHI109.md`](../../sources/05-nowcoder/problems/BISHI109.md)。
> 题解见 [`solutions/BISHI109.py`](../../solutions/BISHI109.py)（已用官方样例验证）。
