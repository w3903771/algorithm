...
见 [10-条件与循环](10-条件与循环.md#104-range-的三个参数)。核心两点：
...
> 每个输出 $n! \bmod (10^9+7)$。
> 题面见 [BISHI63 原题（牛客）](https://www.nowcoder.com/practice/b93729ad46d74a62801bdc320be2aa8e)。
...
- 用 `itertools.accumulate` 可以把这个循环也搬到 C 层（见
  [14-标准库速查](14-标准库速查.md#145-itertools)）：
