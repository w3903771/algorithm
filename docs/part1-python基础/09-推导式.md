...
> 求数组元素之和。
> 题面见 [`sources/05-nowcoder/problems/PIO6.md`](../../sources/05-nowcoder/problems/PIO6.md)。
...
> 题面见 [`sources/05-nowcoder/problems/PIO8.md`](../../sources/05-nowcoder/problems/PIO8.md)。
...
完整题解：[`solutions/PIO6.py`](../../solutions/PIO6.py)、[`solutions/PIO8.py`](../../solutions/PIO8.py)
