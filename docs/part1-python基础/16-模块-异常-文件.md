...
> 每行输出 $a + b$。
> 题面见 [`sources/05-nowcoder/problems/PIO3.md`](../../sources/05-nowcoder/problems/PIO3.md)。
...
[15-面向对象与迭代器生成器](15-面向对象与迭代器生成器.md#155迭代器协议)），
...
完整题解：[`solutions/PIO3.py`](../../solutions/PIO3.py)
