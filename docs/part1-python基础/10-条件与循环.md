...
> **要不要用 for-else？** 我的建议：**自己写可以用，但要留一行注释**。
> 它确实能消除标志变量，但读代码的人（包括三个月后的你）九成会误读成
...
完整题解：[`solutions/BISHI16.py`](https://github.com/w3903771/algorithm/blob/main/solutions/BISHI16.py)、[`solutions/BISHI19.py`](https://github.com/w3903771/algorithm/blob/main/solutions/BISHI19.py)
