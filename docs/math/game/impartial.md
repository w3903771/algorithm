...
直觉：必胜态就是「能把烂摊子甩给对手」，必败态就是「怎么走都是把好局面送给对手」。
...
> 题面见 [原题](https://www.nowcoder.com/practice/9bb882504d574ec287f69e967ce0fb95)。
...
题解见 [`solutions/nowcoder/BISHI35/sol.py`](../../solutions/BISHI35.md)。

### BISHI36　【模板】扩展巴什博弈（较难）

> $T \le 2\times10^6$ 组，每组给 $n, l, r$，每次取 $x \in [l, r]$ 个，取到最后者胜。
> 题面见 [原题](https://www.nowcoder.com/practice/4b0d36a3d3884cf69f618cf4c2511d82)。
...
题解见 [`solutions/nowcoder/BISHI36/sol.py`](../../solutions/BISHI36.md)。

### BISHI34　甜蜜的博弈（简单）

> 剩余 $k$ 个钻石时，可以取 1 个；若 $2 \mid k$ 可以取 2 个；若 $5 \mid k$ 可以取 5 个。
> **无法取走钻石者输**，Alice 先手。$T \le 100$，$N \le 10^9$。
> 题面见 [原题](https://www.nowcoder.com/practice/d3934f2d05624c8fa1a748ef225d0460)。

**这题就是 §1「打表找规律」的完整演练**——注意可选操作依赖于 $k$ 本身，
...
题解见 [`solutions/nowcoder/BISHI34/sol.py`](../../solutions/BISHI34.md)。
