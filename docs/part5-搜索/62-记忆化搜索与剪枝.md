...
配合 [60.4](60-DFS深度优先搜索.md#递归改迭代) 的物理栈数据（Windows 主线程约 2500 层、
64 MB 线程栈约 7 万层），结论是：
...
> 题面见 [`sources/05-nowcoder/problems/BISHI90.md`](../../sources/05-nowcoder/problems/BISHI90.md)。
> 题解见 [`solutions/BISHI90.py`](../../solutions/BISHI90.py)（已用官方样例验证）。
...
> 题解见 [`solutions/BISHI79.py`](../../solutions/BISHI79.py)（已用官方样例验证，用的是递推版）。
...
> 求最多能收集多少金币。
> 题面见 [`sources/05-nowcoder/problems/BISHI146.md`](../../sources/05-nowcoder/problems/BISHI146.md)。
...
（见 [60.4](60-DFS深度优先搜索.md#递归改迭代)），否则在 Windows 上直接静默崩溃。
