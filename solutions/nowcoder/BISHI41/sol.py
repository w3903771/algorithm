...
这题考什么：
    ...
    验算 n = 10：s = 3，Σ_{i=1..3} floor(10/i) = 10+5+3 = 18，2*18 - 9 = 27；
    逐项手算 10+5+3+2+2+1+1+1+1+1 = 27，吻合。

    整除分块与相关数论技巧见 docs/math/number/sqrt-decomposition.md。
...
s = isqrt(n)                    # 整数开方，浮点 n**0.5 在 1e12 附近可能差 1
